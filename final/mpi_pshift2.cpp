...
void smbFft(double *fftBuffer, long fftFrameSize, long sign, double wr, double wi, double arg, double *p1, double *p2,
            double temp, double tr, double ti, double ur, double ui, double *p1r, double *p1i, double *p2r, double *p2i,
            long i, long bitm, long j, long le, long le2, long k);
...
void smbPitchShift(double pitchShift, long numSampsToProcess, long fftFrameSize, long osamp, double sampleRate,
    ...
    /* these are for the fft function */
